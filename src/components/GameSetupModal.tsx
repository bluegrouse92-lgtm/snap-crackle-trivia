...
export const GameSetupModal: React.FC<GameSetupModalProps> = ({
  ...
  return (
    <div className="w-full max-w-4xl mx-auto bg-white/[0.05] backdrop-blur-xl border border-white/10 rounded-3xl p-6 sm:p-9 shadow-2xl relative overflow-hidden">
      ...
      <form onSubmit={handleStart} className="space-y-7 relative z-10">
        ...
        <div>
          <div className="flex items-center justify-between mb-3">
            <label className="block text-sm font-bold text-white font-sans">
              1. Choose Trivia Category or Custom Topic
            </label>
            <span className="text-xs text-purple-300 font-mono flex items-center gap-1.5 bg-purple-500/10 px-2.5 py-1 rounded-full border border-purple-500/20">
            ...
            {TRIVIA_CATEGORIES.map((cat) => {
              ...
              return (
                <button
                  ...
                  className={`p-4 rounded-2xl border-2 text-left transition-all flex flex-col justify-between gap-2.5 group backdrop-blur-lg ${
                    isSelected
                      ? 'bg-purple-500/20 border-purple-400 shadow-lg shadow-purple-500/20 ring-2 ring-purple-400/30'
                ...
                >
                  <div className="flex items-center justify-between">
                    ...
                    {isSelected && (
                      <span className="w-5 h-5 rounded-full bg-purple-400 text-slate-950 flex items-center justify-center font-bold text-xs">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
          ...
          <div>
            ...
            <div className="grid grid-cols-3 gap-2">
              {[
                { val: 15, label: '15s (Turbo)' },
                { val: 25, label: '25s (Standard)' },
                { val: 0, label: 'Untimed' },
              ].map((t) => (
                <button
                  type="button"
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <span className="text-xs text-white/60">
                Spoken commentary, banter, and question intros via Gemini 3.1 Flash Voice Synthesizer
              </span>
            </div>
          </div>
